...
def conectionServer():
    ...
    if clientConnected == False:
        try:
            ...
            print("\nCliente conectando a servidor1...")
            clientConnected = True

            return server1
        except:
            print("\nError. No se puede establecer conexion a servidor1")
            clientConnected = False
            ...
            if clientConnected == False:            
                ...
                print("\nCliente conectando a servidor2...")
                clientConnected2 = True

                return server2
            else:
                print("\nError. No se puede establecer conexion a servidor2")  
                clientConnected2 = False 
    else:
        pass 
